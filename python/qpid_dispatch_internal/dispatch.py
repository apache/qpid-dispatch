...
class QdDll(ctypes.PyDLL):
    ...
    def __init__(self, handle):
        ...
        self._prototype(self.qd_connection_manager_delete_listener, None, [self.qd_dispatch_p, c_char_p])
        self._prototype(self.qd_dispatch_configure_connector, None, [self.qd_dispatch_p, py_object])
        self._prototype(self.qd_connection_manager_delete_connector, None, [self.qd_dispatch_p, c_char_p])
