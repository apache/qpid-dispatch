...
void qd_router_setup_late(qd_dispatch_t *qd)
{
    ...
    qd_router_register_address(qd, CORE_AGENT_ADDRESS, qd_management_agent_handler, (void *) qd, QD_SEMANTICS_DEFAULT, true, 0/*forwarder*/);
    qd_router_register_address(qd, CORE_AGENT_ADDRESS, qd_management_agent_handler, (void *) qd, QD_SEMANTICS_DEFAULT, false, 0/*forwarder*/);
}
