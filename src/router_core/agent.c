                              ...
                              qd_composed_field_t     *body)
{
    ...
    case QD_ROUTER_ROUTER_STATS:      qdr_agent_set_columns(query, attribute_names, qdr_router_columns, QDR_ROUTER_COLUMN_COUNT);  break;
...
void qdr_query_add_attribute_names(qdr_query_t *query)
{
    ...
    case QD_ROUTER_ROUTER_STATS:      qdr_agent_emit_columns(query, qdr_router_columns, QDR_ROUTER_COLUMN_COUNT); break;
