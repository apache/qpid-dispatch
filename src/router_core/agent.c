                              ...
                              uint64_t                 in_conn_id)
{
    ...
    case QD_ROUTER_ATTACH_SUBSCRIPTION: qdr_agent_set_columns(query, attribute_names, qdr_attach_subscription_columns,
                                                              QDR_ATTACH_SUBSCRIPTION_COLUMN_COUNT); break;
    }
...
void qdr_query_add_attribute_names(qdr_query_t *query)
{
    ...
    case QD_ROUTER_ATTACH_SUBSCRIPTION: qdr_agent_emit_columns(query, qdr_attach_subscription_columns, QDR_ATTACH_SUBSCRIPTION_COLUMN_COUNT); break;
    }
}
...
static void qdr_manage_read_CT(qdr_core_t *core, qdr_action_t *action, bool discard)
{
    ...
    case QD_ROUTER_ATTACH_SUBSCRIPTION: qdra_attach_subscription_get_CT(core, name, identity, query, qdr_attach_subscription_columns); break;
   }
...
static void qdr_manage_create_CT(qdr_core_t *core, qdr_action_t *action, bool discard)
{
    ...
    case QD_ROUTER_ATTACH_SUBSCRIPTION: qdra_attach_subscription_create_CT(core, name, query, in_body); break;
...
static void qdr_manage_delete_CT(qdr_core_t *core, qdr_action_t *action, bool discard)
{
    ...
    case QD_ROUTER_ATTACH_SUBSCRIPTION: qdra_attach_subscription_delete_CT(core, query, name, identity); break;
   }
...
static void qdr_manage_update_CT(qdr_core_t *core, qdr_action_t *action, bool discard)
{
    ...
    case QD_ROUTER_ATTACH_SUBSCRIPTION: break;
   }
...
static void qdrh_query_get_first_CT(qdr_core_t *core, qdr_action_t *action, bool discard)
{
    ...
    if (!discard) {
        ...
        case QD_ROUTER_ATTACH_SUBSCRIPTION: qdra_attach_subscription_get_first_CT(core, query, offset); break;
        }
    }
}
...
static void qdrh_query_get_next_CT(qdr_core_t *core, qdr_action_t *action, bool discard)
{
    ...
    if (!discard) {
        ...
        case QD_ROUTER_ATTACH_SUBSCRIPTION: qdra_attach_subscription_get_next_CT(core, query); break;
        }
    }
}
