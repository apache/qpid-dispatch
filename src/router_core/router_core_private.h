...
struct qdr_connection_t {
    ...
    bool                        force_closed; // This bit is used in the case where a client is trying to force close this connection.
};
...
struct qdr_core_t {
    ...
    qdr_connection_force_closed_t conn_force_closed_handler;
