...
#define QDR_ADDRESS_DELIVERIES_TO_ROUTE_CONTAINER   15
#define QDR_ADDRESS_DELIVERIES_FROM_ROUTE_CONTAINER 16
                                          ...
                                          int                  column_index)
{
    ...
    case QDR_ADDRESS_DELIVERIES_TO_ROUTE_CONTAINER:
        qd_compose_insert_ulong(body, addr->deliveries_to_route_container);
        break;

    case QDR_ADDRESS_DELIVERIES_FROM_ROUTE_CONTAINER:
        qd_compose_insert_ulong(body, addr->deliveries_from_route_container);
        break;
