 ...
 * QDRC_EVENT_ADDR_FLOW_LOCAL_CHANGE     Local flow data changed for an address
 * QDRC_EVENT_ADDR_FLOW_REMOTE_CHANGE    Remote flow data changed for an address
 *
...
#define QDRC_EVENT_CONN_OPENED                0x0000000000000001
#define QDRC_EVENT_CONN_CLOSED                0x0000000000000002
#define QDRC_EVENT_CONN_EDGE_ESTABLISHED      0x0000000000000004
#define QDRC_EVENT_CONN_EDGE_LOST             0x0000000000000008
#define QDRC_EVENT_CONN_IR_ESTABLISHED        0x0000000000000010
#define QDRC_EVENT_CONN_IR_LOST               0x0000000000000020
#define _QDRC_EVENT_CONN_RANGE                0x000000000000003F

#define QDRC_EVENT_LINK_IN_ATTACHED           0x0000000000000040
#define QDRC_EVENT_LINK_IN_DETACHED           0x0000000000000080
#define QDRC_EVENT_LINK_OUT_ATTACHED          0x0000000000000100
#define QDRC_EVENT_LINK_OUT_DETACHED          0x0000000000000200
#define QDRC_EVENT_LINK_EDGE_DATA_ATTACHED    0x0000000000000400
#define QDRC_EVENT_LINK_EDGE_DATA_DETACHED    0x0000000000000800
#define _QDRC_EVENT_LINK_RANGE                0x0000000000000FC0

#define QDRC_EVENT_ADDR_ADDED                 0x0000000000001000
#define QDRC_EVENT_ADDR_REMOVED               0x0000000000002000
#define QDRC_EVENT_ADDR_BECAME_LOCAL_DEST     0x0000000000004000
#define QDRC_EVENT_ADDR_NO_LONGER_LOCAL_DEST  0x0000000000008000
#define QDRC_EVENT_ADDR_BECAME_DEST           0x0000000000010000
#define QDRC_EVENT_ADDR_NO_LONGER_DEST        0x0000000000020000
#define QDRC_EVENT_ADDR_ONE_LOCAL_DEST        0x0000000000040000
#define QDRC_EVENT_ADDR_TWO_DEST              0x0000000000080000
#define QDRC_EVENT_ADDR_BECAME_SOURCE         0x0000000000100000
#define QDRC_EVENT_ADDR_NO_LONGER_SOURCE      0x0000000000200000
#define QDRC_EVENT_ADDR_TWO_SOURCE            0x0000000000400000
#define QDRC_EVENT_ADDR_ONE_SOURCE            0x0000000000800000
#define QDRC_EVENT_ADDR_FLOW_LOCAL_CHANGE     0x0000000001000000
#define QDRC_EVENT_ADDR_FLOW_REMOTE_CHANGE    0x0000000002000000
#define _QDRC_EVENT_ADDR_RANGE                0x0000000003FFF000

#define QDRC_EVENT_ROUTER_ADDED               0x0000000010000000
#define QDRC_EVENT_ROUTER_REMOVED             0x0000000020000000
#define QDRC_EVENT_ROUTER_MOBILE_FLUSH        0x0000000040000000
#define QDRC_EVENT_ROUTER_MOBILE_SEQ_ADVANCED 0x0000000080000000
#define _QDRC_EVENT_ROUTER_RANGE              0x00000000F0000000
