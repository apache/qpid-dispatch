...
class CrashingHTTPTest(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.router_qdr = cls.tester.qdrouterd("http-crash-router", config, wait=True)
    ...
    def test_crash_http1_01_weird_server(self):
        ...
        a.close()
        import time
        time.sleep(10)  # give the router time to realize the ground has disappeared under it
        # and crash!
