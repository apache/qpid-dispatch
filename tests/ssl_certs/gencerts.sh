...
keytool -storetype pkcs12 -keystore client.pkcs12 -storepass client-password -alias client-certificate -keypass client-password -genkey  -dname "C=US,ST=ST,L=City,OU=Dev,O=Client,CN=$CLIENT" -validity 99999
