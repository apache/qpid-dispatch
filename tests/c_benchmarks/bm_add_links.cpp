...
BENCHMARK(BM_AddRemoveMultiplePatterns)->Unit(benchmark::kMicrosecond)
->Arg(1)->Arg(3)->Arg(10)->Arg(30)->Arg(100)->Arg(1000)->Arg(3000)->Arg(10000)->Arg(100000)
    ->Complexity();
...
static void BM_TCPEchoServerLatency1QDRSubprocess(benchmark::State &state)
{
    ...
    std::string servAddress     = "127.0.0.1";         // First arg: server address
...
// todo try this on nonlocalhost iface
