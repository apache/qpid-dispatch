...
[id='setting-global-connection-limits-router-{context}']
= Setting global connection limits for a router

You can set the incoming connection limit for a router. This limit defines the total number of concurrent client connections that can be open for this router.
