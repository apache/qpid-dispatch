...
include::assemblies/user-guide/routing-messages-through-router-network.adoc[leveloffset=+1]

// Managing router
include::assemblies/user-guide/managing-router.adoc[leveloffset=+1]
