...
If true, connections from users in this group are permitted to modify the admin status of connections.  This permits termination of sender or receiver connections.  If false, the users of this group are prohibited from terminating any connections. All users, all the time, are prohibited from terminating inter-router connections. Defaults to false
