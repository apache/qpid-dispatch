...
* If the address has no consumers, the router sends back a disposition of RELEASED.

* If the address has one or more consumers, the router sends back a disposition of SETTLED.
