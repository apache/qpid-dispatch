...
include::modules/router-network-connections.adoc[leveloffset=+1]

include::modules/router-addresses.adoc[leveloffset=+1]

include::modules/router-routing.adoc[leveloffset=+1]
