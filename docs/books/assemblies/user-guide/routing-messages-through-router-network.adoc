...
[id='routing-messages-through-router-network-{context}']
...
xref:configuring-link-routing-{context}[Link routing]::
...
include::configuring-link-routing.adoc[leveloffset=+1]
