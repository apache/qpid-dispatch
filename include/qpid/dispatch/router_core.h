...
extern const char * const QDR_CONNECTION_ROLE_NORMAL;
extern const char * const QDR_CONNECTION_ROLE_INTER_ROUTER;
extern const char * const QDR_CONNECTION_ROLE_ROUTE_CONTAINER;
extern const char * const QDR_CONNECTION_ROLE_ON_DEMAND;

extern const char * const QDR_CONNECTION_DIR_IN;
extern const char * const QDR_CONNECTION_DIR_OUT;
